...
*If you want to see something a little more complex, check out [https://github.com/pixlark/Badge/blob/master/tests/samples/linked-list.bdg](this test file) that implements a simple linked in Badge.*
